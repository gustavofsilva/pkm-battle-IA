...
const POKEMON_DATA = {
  ...
  "arbok": {
    "id": 24, "name": "arbok",
    "stats": { "hp": 60, "attack": 95, "defense": 69, "specialAttack": 65, "specialDefense": 79, "speed": 80 }, // Adjusted stats for Arbok based on typical values
  ...
  "golbat": { // Keeping Golbat as per user list, not Crobat
    "id": 42, "name": "golbat",
  ...
  "chansey": { // Keeping Chansey as per user list, not Blissey
    "id": 113, "name": "chansey",
  ...
  "seadra": { // Keeping Seadra as per user list, not Kingdra
    "id": 117, "name": "seadra",
  ...
  "mr. mime": { // Note: Name with space, key might need care
    "id": 122, "name": "mr. mime", // Actual name "mr-mime" in PokeAPI
  ...
  "scyther": { // Keeping Scyther as per user list
    "id": 123, "name": "scyther",
  ...
  // Mew, Mewtwo, Gen2 starters finals, Ampharos, Scizor, Heracross, Tyranitar, Lugia, Ho-oh, Celebi already present and correct.
  // Adding a few more from user's list explicitly if not covered by above copy-paste
};
