...
// Each Pokemon now has 4 moves, with category.
...
const POKEMON_DATA = {
  "venusaur": {
    ...
    "moves": [
      ...
      { "name": "Sleep Powder", "power": 0, "type": "grass", "accuracy": 75, "pp": 15, "category": "status", "effect": { "status": "sleep", "chance": 100, "target": "opponent" } },
  ...
  "beedrill": {
    ...
    "moves": [
        ...
        { "name": "Aerial Ace", "power": 60, "type": "flying", "accuracy": 100, "pp": 20, "category": "physical", "effect": null },
  ...
  "pidgeot": {
    ...
    "moves": [
        { "name": "Hurricane", "power": 110, "type": "flying", "accuracy": 70, "pp": 10, "category": "special", "effect": { "status": "confusion", "chance": 30, "target": "opponent" } },
  ...
  "gengar": {
    ...
    "moves": [
      { "name": "Shadow Ball", "power": 80, "type": "ghost", "accuracy": 100, "pp": 15, "category": "special", "effect": { "stat_change": { "stat": "specialDefense", "stages": -1, "chance": 20, "target": "opponent" } } },
      { "name": "Sludge Wave", "power": 95, "type": "poison", "accuracy": 100, "pp": 10, "category": "special", "effect": { "status": "poison", "chance": 10, "target": "opponent" } },
      { "name": "Focus Blast", "power": 120, "type": "fighting", "accuracy": 70, "pp": 5, "category": "special", "effect": { "stat_change": { "stat": "specialDefense", "stages": -1, "chance": 10, "target": "opponent" } } },
      { "name": "Hypnosis", "power": 0, "type": "psychic", "accuracy": 60, "pp": 20, "category": "status", "effect": { "status": "sleep", "chance": 100, "target": "opponent" } }
    ]
  },
  "snorlax": {
    "id": 143, "name": "snorlax",
    ...
    "moves": [
      { "name": "Body Slam", "power": 85, "type": "normal", "accuracy": 100, "pp": 15, "category": "physical", "effect": { "status": "paralysis", "chance": 30, "target": "opponent" } },
      { "name": "Rest", "power": 0, "type": "psychic", "accuracy": 100, "pp": 5, "category": "status", "effect": { "status": "sleep", "duration": 2, "heal": "full", "target": "self" } },
      { "name": "Earthquake", "power": 100, "type": "ground", "accuracy": 100, "pp": 10, "category": "physical", "effect": null },
      { "name": "Crunch", "power": 80, "type": "dark", "accuracy": 100, "pp": 15, "category": "physical", "effect": { "stat_change": { "stat": "defense", "stages": -1, "chance": 20, "target": "opponent" } } }
    ]
  },
  ...
  // Other Pokemon from the user's list would be similarly updated to have 4 moves with categories.
};
