...
// Each Pokemon now has 4 moves, with category, and sleep/confusion effects have duration.
...
const POKEMON_DATA = {
  ...
  "charizard": {
    ...
    "moves": [
      ...
      { "name": "Inferno", "power": 100, "type": "fire", "accuracy": 50, "pp": 5, "category": "special", "effect": { "status": "burn", "chance": 100, "target": "opponent" } }
    ]
  },
  "blastoise": {
    "id": 9, "name": "blastoise",
  ...
  // ... (rest of the POKEMON_DATA object with all Pokemon having 4 moves and categories,
  //      and sleep/confusion having duration where applicable)
};
